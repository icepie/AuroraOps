...
- Not updated on 2026-06-09: device 1 needs valid sudo for remote aarch64 build/install; device 8 needs the correct SSH password; device 7 needs the correct sudo password.
...
- Valid SSH password for `gg@192.168.2.101`.
